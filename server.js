...
30-MINUTE / HIGH-ENERGY RULE:
When availableMinutes = 30 AND energy = high:
...
// ─── MESSAGE BUILDER ──────────────────────────────────────────────────────────
const buildMessages = ({ tasks, availableTasks, history, feedbackContext, availableMinutes, energy, activeThread }) => {
