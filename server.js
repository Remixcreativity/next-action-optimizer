...
H2. Progressive closure pressure:
   ...
   A closure action must include final verification/save/submit/confirm when applicable and should say to mark/remove the parent task if successful.
