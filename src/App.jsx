...
export default function App() {
  ...
  return (
    <div style={S.root}>
      ...
      <div style={S.topbar}>
        <button style={S.ghostBtn} onClick={() => screen !== "input" && handleBackToInput()}>
          {screen !== "input" ? "← tasks" : <span style={{ color: "#8899bb" }}>NAO</span>}
        </button>
      ...
      <div style={S.card}>
        ...
        {screen === "profile" && (
          <ProfileScreen history={history} onClose={handleBackToInput} />
        )}
      </div>
    </div>
  );
